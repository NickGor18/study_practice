...
import {
    ...
    take,
    filter,
    distinctUntilChanged, debounceTime, pluck, map, tap, concatMapTo, mergeMapTo, switchMapTo
} from 'rxjs/operators';
...
(function task1(): void {
    ...
    // const stream$ = interval()
    //     .pipe(
    //         concatMap(() => of(randomDelay(1, 10)).pipe(delay(randomDelay(1000, 5000))))
    //     )
    //
    // run(stream$);
})();
...
(function task3_2(): void {
    ...
    //         switchMap(number => ajax(`https://api.github.com/users?per_page=${number}`)
    //             .pipe(debounceTime(1000))),
    //         pluck("response"),
    //         tap(resp => console.log(resp)),
    //         map(response => response.map(elem => elem.login))
    //     )
    //
    // run(stream$);
})();
...
(function task5() {
    // const clicks$ = fromEvent(document.getElementById('runBtn'), 'click')
    // const stream$ = clicks$.pipe(
    //     concatMapTo(concat(of('Hello', 'World'), NEVER))
    // )
    //
    // run(stream$);
})();
...
(function task6() {
    // const clicks$ = fromEvent(document.getElementById('runBtn'), 'click')
    // const stream$ = clicks$.pipe(
    //     mergeMapTo(concat(of('Hello', 'World'), NEVER))
    // )
    //
    // run(stream$);
})();
